  ...
  void configure(HttpSecurity http) throws Exception {
    ...
    if(isAgentAPIUnauthenticatedAccessEnabled && isSpinnakerWebhooksUnauthenticatedAccessEnabled){
      http
        ...
        .antMatchers(HttpMethod.GET,'/autopilot/api/v2/autopilot/canaries/{id:[0-9]+}').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v1/autopilot/canaries/{id:[0-9]+}').permitAll()
        ...
        .antMatchers(HttpMethod.GET,'/autopilot/canaries/{id:[0-9]+}').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/v5/canaries/{id:[0-9]+}').permitAll()
        ...
        // Start of report page APIs, Need to remove them once token based authentication is in place.
        .antMatchers(HttpMethod.GET,'/autopilot/api/v2/permissions/getApplications').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v1/applications/{source1}/tags').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v2/applications/getApplicationHealth').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v1/defaultLogTemplate').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/cas/getCanaryOutputNew').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v1/correlation/log/{source1}/{source2}').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v1/correlation/metric').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/logs/feedbackHistory').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v5/global/template').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v4/monitoringproviders/log').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v1/scoring-algorithms').permitAll()
        .antMatchers(HttpMethod.GET,'/platformservice/v6/users/{source1}/datasources').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v4/monitoringproviders/custom').permitAll()
        .antMatchers(HttpMethod.GET,'/autopilot/api/v4/monitoringproviders/apm').permitAll()
        .antMatchers(HttpMethod.GET,'/dashboardservice/v2/users/{source1}/applications/latest-canary').permitAll()
