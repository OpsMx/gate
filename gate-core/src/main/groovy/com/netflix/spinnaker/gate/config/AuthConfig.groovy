  ...
  void configure(HttpSecurity http) throws Exception {
    ...
    if(isAgentAPIUnauthenticatedAccessEnabled && isSpinnakerWebhooksUnauthenticatedAccessEnabled){
      http.authorizeHttpRequests((authz) ->
        ...
        .requestMatchers(HttpMethod.POST,'/oes/echo/').permitAll()
        .requestMatchers(HttpMethod.POST,'/auditservice/v1/acctEnvMapping').permitAll()
        .requestMatchers(HttpMethod.PUT,'/auditservice/v1/acctEnvMapping').permitAll()
        .requestMatchers(HttpMethod.GET,'/auditservice/v1/acctEnvMapping').permitAll()
        .requestMatchers(HttpMethod.POST,'/auditservice/v1/acctEnvMapping/bulkimport').permitAll()
        .requestMatchers(HttpMethod.GET,'/auditservice/v1/acctEnvMapping/import').permitAll()
