  ...
  void configure(HttpSecurity http) throws Exception {
    ...
    if(isAgentAPIUnauthenticatedAccessEnabled && isSpinnakerWebhooksUnauthenticatedAccessEnabled){
      http.authorizeHttpRequests((authz) ->
        ...
        .requestMatchers(HttpMethod.GET,'/autopilot/api/v2/autopilot/canaries/{id:[0-9]+}').permitAll()
        .requestMatchers(HttpMethod.GET,'/autopilot/api/v1/autopilot/canaries/{id:[0-9]+}').permitAll()
        ...
        .requestMatchers(HttpMethod.POST,'/autopilot/api/v5/registerCanary').permitAll()
        .requestMatchers(HttpMethod.GET,'/autopilot/canaries/{id:[0-9]+}').permitAll()
        .requestMatchers(HttpMethod.GET,'/autopilot/v5/canaries/{id:[0-9]+}').permitAll()
        .requestMatchers(HttpMethod.GET,'/autopilot/api/v5/external/template').permitAll()
        .requestMatchers(HttpMethod.POST,'/autopilot/api/v5/external/template').permitAll()
   ...
   void jwtconfigure(HttpSecurity http) throws Exception {
     if (isAgentAPIUnauthenticatedAccessEnabled && isSpinnakerWebhooksUnauthenticatedAccessEnabled){
       ...
       http
         ...
         .requestMatchers(HttpMethod.GET,'/autopilot/v5/canaries/{id}').permitAll()
         .requestMatchers(HttpMethod.POST,'/visibilityservice/v1/approvalGates/{id}/trigger').permitAll()
         .requestMatchers(HttpMethod.POST,'/visibilityservice/v2/approvalGates/{id}/trigger').permitAll()
         .requestMatchers(HttpMethod.POST,'/visibilityservice/v4/approvalGates/{id}/trigger').permitAll()
         .requestMatchers(HttpMethod.POST,'/visibilityservice/v5/approvalGates/{id}/trigger').permitAll()
