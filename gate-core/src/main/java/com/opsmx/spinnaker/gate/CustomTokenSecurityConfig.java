...
public class CustomTokenSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  //        .antMatchers(
  //            HttpMethod.GET,
  // "/oes/accountsConfig/v1/agents/{agentName}/manifest/apple/automation")
  //        .antMatchers(
  //            HttpMethod.GET,
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    ...
    //        .antMatchers(
    //            HttpMethod.PUT,
    // "/visibilityservice/v1/approvalGateInstances/{id}/spinnakerReview")
    //        .permitAll()
    //        .antMatchers(HttpMethod.POST, "/oes/echo")
    //        .permitAll()
    //        .antMatchers(HttpMethod.POST, "/oes/echo/")
    ...
    //        .permitAll()
    //        .antMatchers(HttpMethod.GET,
    // "/dashboardservice/v4/getAllDatasources/apple/automation")
    //        .permitAll()
    //        .antMatchers(
    //            HttpMethod.GET,
    //
