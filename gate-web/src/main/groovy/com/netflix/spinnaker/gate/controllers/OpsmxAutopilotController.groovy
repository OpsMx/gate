 ...
 */
  ...
  Object getAutoResponse13(@PathVariable("type") String type,
                           ...
                           @RequestHeader(value = "x-spinnaker-user",required = false) String xSpinnakerUser) {
    return opsmxAutopilotService.getAutoResponse13(type, source, source1, source2, templateName, versionNo, xSpinnakerUser)
  }
  ...
  Object getAutoResponse12(@RequestParam(value = "templateType", required = false) String templateType,
    ...
    return opsmxAutopilotService.getAutoResponse12( templateType, isFindAllVersions, search, sort, pageLimit, sortBy, days, page)
  }
