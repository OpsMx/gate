...
public class ArtifactController {
  ...
  @Operation(
      summary =
          "Retrieve the available artifact versions for an artifact provider and package name releaseStatus is an optional comma separated list of statuses to filter on.")
