...
class CredentialsController {
  ...
  List<ClouddriverService.AccountDefinition> getAccountsByType(
    @Parameter(name = 'Value of the "@type" key for accounts to search for.', example = 'kubernetes')
    @PathVariable String accountType,
    @Parameter(name = 'Maximum number of entries to return in results. Used for pagination.')
    @RequestParam OptionalInt limit,
    @Parameter(name = 'Account name to start account definition listing from. Used for pagination.')
  ...
  ClouddriverService.AccountDefinition createAccount(
    @Parameter(name = 'Account definition body including a discriminator field named "type" with the account type.')
  ...
  @Alpha
  void deleteAccount(
    @Parameter(name = 'Name of account definition to delete.')
