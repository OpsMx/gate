 ...
 */
  ...
  @ResponseBody Object downloadSampleTemplate(@PathVariable("version") String version, @RequestParam(value = "file") String file) {
    Response response = opsmxPlatformService.downloadSampleTemplate(version, file)
    InputStream inputStream = response.getBody().in()
    try {
